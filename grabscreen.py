...
class grab_screen:
    def __init__(self, region=None, window_title='Game', window_handle=None):
        ...
        self.screen = windows_screen_grab(window_title=self.window_title, region=self.region,
...
class windows_screen_grab:
    ...
    def get_screen_bits(self):
        self._memDC.StretchBlt((0, 0), (self._width, self._height), self._windowDC, (self._top, self._left),
